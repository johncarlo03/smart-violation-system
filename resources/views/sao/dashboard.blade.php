        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                    ...
                    <div class="space-y-5">
                        @php
                            // Get the maximum total safely from the first item if it exists
                            $maxTotal = $topOffenses->first()->total ?? 0;
                        @endphp

                        @forelse($topOffenses as $item)
                            <div>
                        ...
                        @empty
                            @for ($i = 0; $i < 5; $i++)
                                <div class="animate-pulse">
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-2.5">
                                        <div class="bg-gray-250 h-2.5 rounded-full"
                                            style="width: {{ [40, 25, 60, 15, 30][$i] }}%"></div>
                                    </div>
                                </div>
                            @endfor

                            <p class="text-xs text-center text-gray-400 mt-2 italic">
                                No active violations recorded yet. Showing placeholders.
                            </p>
                        @endforelse
                    </div>
                </div>
                        ...
                        @foreach($deptStats as $dept)
                            <div class="flex flex-col items-center">
                                ...
                                <div class="relative group">
                                    <div class="bg-gradient-to-t {{ ($dept->barColor) }} w-14 rounded-t-2xl shadow-md transition-all duration-300 group-hover:scale-105"
                                                    ...
                                                    <tr class="hover:bg-indigo-50/40 transition duration-200">
                                                        ...
                                                        <td class="px-6 py-5">
                                                            <div class="flex items-center gap-4">
                                                                ...
                                                                @else
                                                                    <div
                                                                        class="w-12 h-12 rounded-full {{ $v->department->badgeColor ?? 'bg-gray-100' }} flex items-center justify-center font-black text-sm shadow-sm">
                                                        ...
                                                        <td class="px-6 py-5 text-center">
                                                            ...
                                                            <span
                                                                class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-black tracking-wider uppercase border                                                                                                                                                                                                                         {{ $v->status === 'pending'
